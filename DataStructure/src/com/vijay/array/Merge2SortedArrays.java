...
public class Merge2SortedArrays {
	...
	public static void moveToEnd(int[] MplusN, int[] N){
		 ...
		 // 1-1-15157121522  ---->  this array will come as first 4 indexes are not considered because that is the required for array N and its elements
	...
	public static void mergeTwoArrays(int[] MplusN,int[] N){
		...
		while(k<MplusN.length){
			...
			//(j == N.length) || --> Used to specify if there is no element remaining in 2nd array,
